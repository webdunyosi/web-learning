  ...
  return (
    <div className="h-screen w-full bg-[#07090d] flex font-sans text-gray-300 selection:bg-green-500/30 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div
          className="absolute top-[20%] left-[10%] w-[80vw] h-[80vw] md:w-[30vw] md:h-[30vw] bg-emerald-400/25 rounded-full blur-[60px] md:blur-[80px] anim-liquid-fast mix-blend-screen"
