...
const StudentSidebar = ({ isSidebarOpen, setIsSidebarOpen, navItems }) => {
  ...
  return (
    <>
      ...
      >
        {/* Shisha effekti uchun gradient nur */}
        ...
        <div className="h-20 flex items-center justify-between px-6 border-b border-white/10 shrink-0 relative z-10">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-[0_0_20px_rgba(34,197,94,0.4)] border border-white/20">
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all duration-300 relative overflow-hidden group ${
                  isActive 
                    ? 'text-green-300 bg-white/[0.06] border border-white/10 shadow-[inset_0_0_20px_rgba(34,197,94,0.15)] backdrop-blur-md' 
                    : 'text-gray-400 hover:text-gray-200 hover:bg-white/[0.04] border border-transparent'
                }`}
              >
                {/* Aktiv menyu uchun yon neon chiziq */}
                {isActive && (
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-green-400 shadow-[0_0_15px_rgba(34,197,94,1)] rounded-r-md"></div>
                )}
        ...
        {/* Tizimdan chiqish qismi butunlay olib tashlandi */}
      </aside>
    </>
  );
};
